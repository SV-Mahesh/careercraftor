        ...
        <React.Fragment>
            <nav className="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
                <div className="container">
                    ...
                    {/* Image Logo */}
                    <Link className="navbar-brand logo-image" to='/' ><img src="images/logo.png" alt="alternative" style={{height:'5.7rem'}} /></Link>
                    ...
                    <div className="collapse navbar-collapse">
                        <ul className="navbar-nav ml-auto active">
                            <li className={state.title === 1 ? "nav-item active" : "nav-item"} onClick={handleMenu} id={1}>
                                <Link className="nav-link page-scroll" to='/'>HOME</Link>
                            </li>
                            <li className={state.title === 2 ? "nav-item active" : "nav-item"} onClick={handleMenu} id={2}>
                                <Link className="nav-link page-scroll" to="about">ABOUT US</Link>
                            </li>
                            <li className={state.title === 3 ? "nav-item active" : "nav-item"} onClick={handleMenu} id={3}>
                                <Link className="nav-link page-scroll" to="services">SERVICES</Link>
                            </li>
                            <li className={state.title === 4 ? "nav-item active" : "nav-item"} onClick={handleMenu} id={4}>
